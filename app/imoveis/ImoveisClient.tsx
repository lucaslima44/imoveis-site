...
export default function ImoveisClient({ initialProperties }: { initialProperties: Property[] }) {
  ...
  const [sortOption, setSortOption] = useState<"recentes" | "antigos" | "valor_desc" | "valor_asc">("recentes");
  ...
  // Aplica ordenação no cliente conforme seleção
  const sorted = filtered.slice().sort((a, b) => {
    switch (sortOption) {
      case "recentes": {
        // Supõe id numérico incremental; converte para número para ordenar
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <select
              ...
              className="text-sm py-2 px-3 bg-cream-100 border border-cream-300 text-navy-900 focus:outline-none"
            >
