        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="bg-cream-50 shadow-[0_2px_20px_rgba(15,30,43,0.08)] p-7 sticky top-32">
              ...
              <a href="tel:+5511999999999" className="flex items-center justify-center gap-2 w-full border border-navy-900 text-navy-900 py-4 font-body font-medium tracking-[0.1em] uppercase text-sm hover:bg-navy-900 hover:text-cream-50 transition-all duration-300">
