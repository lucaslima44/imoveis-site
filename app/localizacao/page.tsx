        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          ...
          <div className="lg:col-span-2 order-1 lg:order-2 space-y-6">
            ...
            {contactInfo.map((info, i) => (
              <div
                key={i}
                className="flex items-start gap-4 p-5 bg-cream-50 card-shadow group"
              >
                <div className="w-10 h-10 bg-navy-900 flex items-center justify-center shrink-0 group-hover:bg-gold-500 transition-colors duration-300">
                  <info.icon size={16} className="text-gold-400 group-hover:text-cream-50 transition-colors duration-300" />
                </div>
                <div>
